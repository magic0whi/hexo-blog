...
* 6-11-2021 好久不见, 最近因为琐事而没有时间更新这里的日志, 道歉.
  ...
  我日常的作业系统已由 Windows10换到了 Arch Linux, 主要是出于我只有 4G RAM 的 Surface 已经难以满足在打开 Edge、VSCode、网易云音乐的情况下流畅运行. 而 Krita 在 [Linux-Surface](https://github.com/linux-surface/) 内核下对 Surface Pen 的支持令我满意. 更别提那些 Btrfs 的 Compress=zstd、Dm-crypt 这些 Linux 特有的黑科技了. 摄像头不能用? 太好了, 这样摄像头就不用贴贴纸堵住了. 总之, 除了 KDE 时不时出现的一些 Bug 外, 以及 SDDM 作为登陆管理会导致 NetworkManager 的服务莫名其妙启动失败--因此我现在用的是 GDM+KDE 这样的奇怪组合, Arch Linux 还是不错滴.

  还有我至今依旧没有去学 Rust, 且那个在 6 月 15 日前学完线性代数的 Deadline 已经遥遥逼近, 我觉得我这么怠惰可以提前爬一爬谢罪了.
